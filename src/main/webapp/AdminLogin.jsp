<%-- 
    Document   : AdminLogin
    Created on : 16 Sept 2025, 3:15:23 pm
    Author     : padol
--%>
    ...
    <style>
        * {
        ...
        .form-box::after {
            ...
            right: -2px;
            bottom: -2px;
            background: linear-gradient(45deg, #e74c3c, #c0392b, #3498db, #9b59b6);
            background-size: 400%;
            border-radius: 24px;
            z-index: -1;
            opacity: 0;
        ...
        h2 {
            ...
            font-weight: 700;
            letter-spacing: 2px;
            text-shadow: 0 0 30px rgba(231, 76, 60, 0.7), 0 0 60px rgba(231, 76, 60, 0.5);
            margin-bottom: 10px;
            animation: glow 3s ease-in-out infinite;
        }

        @keyframes glow {
            0%, 100% { text-shadow: 0 0 30px rgba(231, 76, 60, 0.7), 0 0 60px rgba(231, 76, 60, 0.5); }
            50% { text-shadow: 0 0 40px rgba(231, 76, 60, 0.9), 0 0 80px rgba(231, 76, 60, 0.7); }
        }
        ...
        input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(231, 76, 60, 0.2), 0 0 20px rgba(231, 76, 60, 0.3);
        }
...
<body>
    ...
    <div class="form-box">
        <div class="icon-header">
            <div class="icon">🔐</div>
            <h2>ADMIN LOGIN</h2>
            <p class="subtitle">Administrative Access Portal</p>
        </div>
